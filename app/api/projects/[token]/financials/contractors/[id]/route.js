...
export async function PUT(req, { params }) {
  try {
    ...
    const allowed = ['description', 'activity_id', 'invoice_date', 'invoice_amount', 'rd_portion'];
    const updates = {};
    ...
    await logAudit(req, {
      action: 'financials.contractors.update',
    ...
    console.error('Contractors PUT error:', error);
...
export async function DELETE(req, { params }) {
  try {
    ...
    await logAudit(req, {
      action: 'financials.contractors.delete',
      resourceType: 'fin_contractors',
      resourceId: id,
      projectId: project.id,
      userId: user.id,
