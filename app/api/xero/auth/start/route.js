...
export async function POST(req) {
  ...
  xeroAuthUrl.searchParams.set('scope', 'openid profile email offline_access payroll.employees payroll.payruns payroll.settings accounting.transactions accounting.contacts');
