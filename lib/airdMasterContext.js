...
**Format:**
- Use plain text with markdown headers (##, ###)
...
A complete claim pack has 11 sections:

1. **RDTI Overview** - What the RDTI is (1 page summary)
2. **Eligible R&D** - What counts as eligible R&D for software
3. **Project Overview** - Technical problem, prior art, uncertainty
4. **Core Activities** - Detailed statements per activity (H→E→O→Ev→C)
5. **Supporting Activities** - Dominant-purpose linked activities
6. **Evidence Index** - Contemporaneous records inventory
7. **Financials** - Notional deductions, apportionment, offset calculation
8. **R&D Boundary** - What was/wasn't claimed and why
9. **Overseas/Contracted** - Findings, RSPs, related parties (if applicable)
10. **Registration Tie-out** - Portal descriptions, ATO schedule mapping
11. **Attestations** - Internal sign-offs, methodology acknowledgements
...
export const SECTION_KEYS = {
  RDTI_OVERVIEW: 'rdti_overview',
  ELIGIBLE_RD: 'eligible_rd',
...
export const SECTION_NAMES = {
  [SECTION_KEYS.RDTI_OVERVIEW]: 'What the RDTI Is',
  [SECTION_KEYS.ELIGIBLE_RD]: 'What Counts as Eligible R&D',
