// ClaimFlow Master Context Pack — AU R&D Tax Incentive (Software)
// Complete RDTI guidelines for AI claim pack generation
// Based on ITAA 1997 s.355-25 and AusIndustry May 2024 guidance

export const CLAIMFLOW_SYSTEM_PROMPT = `You are an expert in Australian R&D Tax Incentive (RDTI) compliance for software companies.
...
1. **Project Overview** - Technical problem, existing knowledge, uncertainty
...
export const SECTION_NAMES = {
  [SECTION_KEYS.PROJECT_OVERVIEW]: 'Project Overview & Existing Knowledge',
