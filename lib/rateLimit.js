...
export const RATE_LIMITS = {
  ...
  // Per-IP limits for knowledge upload
  KNOWLEDGE_PER_IP: {
    maxTokens: 50,         // 50 uploads
    refillRate: 50,        // Refill 50 tokens
    refillInterval: 3600,  // Per hour
    keyPrefix: 'rl:ip:knowledge:'
  },

  // Per-project limits for knowledge upload
  KNOWLEDGE_PER_PROJECT: {
    maxTokens: 200,        // 200 uploads
    refillRate: 200,       // Refill 200 tokens
    refillInterval: 3600,  // Per hour
    keyPrefix: 'rl:proj:knowledge:'
  }
};
